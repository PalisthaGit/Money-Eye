...
type Nav = NativeStackNavigationProp<HomeStackParamList, 'InvestmentLog'>;
...
const INVEST_CATEGORIES = ['All', 'Gold', 'Stocks', 'Mutual Fund', 'Real Estate', 'Crypto', 'Other'];
...
export default function InvestmentLogScreen() {
  ...
  const totalInvested = filteredEntries.reduce((s, e) => s + e.amount, 0);
  ...
  return (
    <View style={[styles.flex, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Investment Log</Text>
      </View>
      ...
      <View style={styles.summaryStrip}>
        <Text style={styles.summaryText}>Total invested: {fmt(totalInvested, currency)}</Text>
        {topCategory && (
      ...
      {sortedEntries.length === 0 ? (
        <View style={styles.emptyContainer}>
          <Text style={styles.emptyText}>
            No investment entries for {monthLabel} {selectedYear}.{'\n'}Try a different filter.
          </Text>
        </View>
      ) : (
        <FlatList
